...
import 'package:littlemallapp/model/login_success_res.dart';
...
//        autovalidate: true,
  ...
  Widget buildSignInButton() {
    return GestureDetector(
      ...
      onTap: () {
        String emial =
            Provider.of<SignUpPageStore>(context, listen: false).emial;
        String password =
            Provider.of<SignUpPageStore>(context, listen: false).password;
        print('emial:' + emial);
        ...
        if (_SignInFormKey.currentState.validate()) {
          ...
          Repo().login({"email": emial, "password": password}).then((re) async {
            login_success_res res = login_success_res.fromJson(re);
            print(res.code);
            if (res.code == 200) {
